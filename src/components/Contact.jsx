    ...
    return (
        <section className='bg-blue-100'>
            ...
            <div className='text-center py-10 '>
                ...
                <a href='https://calendly.com/isratjahantanny15/consultation-support' className='border text-xl px-5 py-3
                hover:bg-blue-600 hover:text-white border-blue-600 text-blue-600 rounded-md'>Book a Call</a>
            </div>
        </div>
        </section>
    );
